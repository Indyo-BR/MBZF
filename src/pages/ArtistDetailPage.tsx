...
export default function ArtistDetailPage() {
  ...
  const waLink = `https://wa.me/${artist.whatsapp}?text=${waMessage}`
  ...
  return (
    <div className="pb-10">
      ...
      <div className="px-6 pt-6">
        ...
        {/* Privates CTA → WhatsApp */}
        <a
          href={waLink}
          target="_blank"
          rel="noopener noreferrer"
          className="flex items-center justify-center gap-3 w-full bg-tropical-green text-white py-4 rounded-full font-bebas text-2xl tracking-widest shadow-lg active:scale-95 transition-transform"
        >
          <WhatsAppIcon className="w-6 h-6" />
          Privates
        </a>
        <p className="text-center text-[11px] text-outline mt-2 mb-6">
          Aulas particulares · fale direto com o artista pelo WhatsApp
        </p>
